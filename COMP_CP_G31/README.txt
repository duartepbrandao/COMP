...
>Pode criar 1 .jar em vez de executar com "java -cp" com:java -cfm Exp1.jar Manifest.txt *.class

>Se alterar o código fonte terá que repetir o processo acima descrito

//===================================================================================
	DESCRICAO DE UTILIZACAO
//===================================================================================

Executar o analisador sintáctico:java -jar Exp1.jar;
...
tratar de bibliografias reais.
Alguns items apresentam entries não consideradas, também não são usados
@preambles, sendo que alguns items são originadores de erros, 
mas dentro dos possíveis é realizado o output até chegar ao
último item.
